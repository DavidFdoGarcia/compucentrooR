...
namespace Compucentro4 {
    ...
    public partial class empleado : global::System.Data.DataSet {
        ...
        public partial class EmpleadoDataTable : global::System.Data.TypedTableBase<EmpleadoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public EmpleadoRow AddEmpleadoRow(string nombre, string direccion, int telefono) {
...
namespace Compucentro4.empleadoTableAdapters {
    ...
    public partial class EmpleadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Empleado] ([nombre], [direccion], [telefono]) VALUES (@nombre," +
                " @direccion, @telefono);\r\nSELECT idEmpleado, nombre, direccion, telefono FROM Em" +
                "pleado WHERE (idEmpleado = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Empleado] SET [nombre] = @nombre, [direccion] = @direccion, [telefono] = @telefono WHERE (([idEmpleado] = @Original_idEmpleado) AND ((@IsNull_nombre = 1 AND [nombre] IS NULL) OR ([nombre] = @Original_nombre)) AND ((@IsNull_direccion = 1 AND [direccion] IS NULL) OR ([direccion] = @Original_direccion)) AND ((@IsNull_telefono = 1 AND [telefono] IS NULL) OR ([telefono] = @Original_telefono)));
SELECT idEmpleado, nombre, direccion, telefono FROM Empleado WHERE (idEmpleado = @idEmpleado)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idEmpleado, nombre, direccion, telefono FROM dbo.Empleado";
        ...
        public virtual int Fill(empleado.EmpleadoDataTable dataTable) {
        ...
        public virtual empleado.EmpleadoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(empleado.EmpleadoDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(empleado dataSet) {
        ...
        public virtual int Delete(int Original_idEmpleado, string Original_nombre, string Original_direccion, global::System.Nullable<int> Original_telefono) {
        ...
        public virtual int Update(string nombre, string direccion, global::System.Nullable<int> telefono, int Original_idEmpleado, string Original_nombre, string Original_direccion, global::System.Nullable<int> Original_telefono, int idEmpleado) {
            if ((nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nombre, string direccion, global::System.Nullable<int> telefono, int Original_idEmpleado, string Original_nombre, string Original_direccion, global::System.Nullable<int> Original_telefono) {
            return this.Update(nombre, direccion, telefono, Original_idEmpleado, Original_nombre, Original_direccion, Original_telefono, Original_idEmpleado);
        }
    }
