...
namespace Compucentro4.ClienteTableAdapters {
...
SELECT idUsuario, idRango, Nombre, Direccion, Telefono, Celular FROM Usuario WHERE (idUsuario = @idUsuario)";
        ...
        public virtual int Fill(Cliente.UsuarioDataTable dataTable) {
        ...
        public virtual Cliente.UsuarioDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Cliente.UsuarioDataTable dataTable = new Cliente.UsuarioDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Cliente.UsuarioDataTable dataTable) {
